...
class CommentScreen extends StatefulWidget {
  ...
  const CommentScreen({
    ...
    required this.price, required this.ticketUserId,
  }) : super(key: key);
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      MessageModel
                                                                          ...
                                                                          MessageModel(
                                                                        message:
                                                                            "Hey, I hope you are good.You have to pay the '\$${commentData[index].offerPrice}' to purchase the '${ticketData![index].ticketType} TICKET' for festival '${eventData.eventName}'",
                                                                        userIDReceiver:
                                                                            userData
                                                                                .id,
                                                                        userIDSender: AuthServices
                                                                            .getCurrentUser
                                                                            .uid,
                                                                      );
                                                                      NotificationModel
                                                                        ...
                                                                        title:
                                                                            'Offer Accepted',
                                                                        body:
                                                                            "Your offered price'\$${commentData[index].offerPrice}' for '${ticketData[index].ticketType} TICKET' is confirmed for festival '${eventData.eventName}'",
                                                                        userId:
                                                                            userData
                                                                                .id,
                                                                        id: AuthServices
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child: InkWell(
                                                                                onTap: () async {
                                                                                  ...
                                                                                  await NotificationServices.sendNotification(token: ticketUserData!.fcmToken!, title: 'Offered Price', body: '${AuthServices.getCurrentUser.displayName} offered a price "${priceController.text}" for event "${eventData.eventName}"', data: {});
